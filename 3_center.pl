...
# the 3-center overlap integrals.  The overlap formalism is readily 
...
sub twoCenterOL {
  ...
  foreach $orbital2 (1..$orb2) {
    foreach $orbital1 (1..$orb1) {
      ...
      # General reductions and substitutions
      ...
      #if ($string =~ m/coef\*\(\(PA\(1\)\*\*3\)\*\(PB\(1\)\*\*2\). 
      #                  \+ 0.5\*\(PA\(1\)\*\*3\)\*Y1.
      #                  \+ 3\*\(PA\(1\)\*\*2\)\*PB\(1\)\*Y1.
      #                  \+ 1.5\*PA\(1\)\*\(PB\(1\)\*\*2\)\*Y1.
      #                  \+ 2.25\*PA\(1\)\*Y2.
      #                  \+ 1.5\*PB\(1\)\*Y2\)\*/) {
      #  $string =~ s/coef\*\(\(PA\(1\)\*\*3\)\*\(PB\(1\)\*\*2\).
      #                \+ 0.5\*\(PA\(1\)\*\*3\)\*Y1.
      #                \+ 3\*\(PA\(1\)\*\*2\)\*PB\(1\)\*Y1.
      #                \+ 1.5\*PA\(1\)\*\(PB\(1\)\*\*2\)\*Y1. 
      #                \+ 2.25\*PA\(1\)\*Y2.
      #                \+ 1.5\*PB\(1\)\*Y2\)\*/wo\(18,5\)\*/g;
      #}
